...
class TestPlannerAgentParsing(unittest.TestCase):
    ...
    def test_parse_valid_json(self):
        ...
        valid_json = '{"plan": [{"agent": "casual", "id": "1", "task": "Explain topic", "need": []}]}'
    ...
    def test_parse_truncated_json_returns_empty(self):
        ...
        truncated_json = '{"plan": [{"agent": "casual", "id": "1", "task": "Explain'
    ...
    def test_parse_multiple_tasks(self):
        ...
        multi_task_json = '{"plan": [{"agent": "casual", "id": "1", "task": "Explain", "need": []}, {"agent": "coder", "id": "2", "task": "Code it", "need": ["1"]}]}'
